...
public enum BaseResponseStatus {
    ...
    WITHDRAWAL_USER(HttpStatus.FORBIDDEN, false, 2106, "탈퇴한 회원입니다."),
    NO_EXIST_USER(HttpStatus.NOT_FOUND, false, 2107, "존재하지 않는 유저 정보입니다."),
    USER_STATUS_IS_NOT_FOUND(HttpStatus.NOT_FOUND, false, 2108, "존재하지 않는 유저 상태입니다."),
    ...
    PASSWORD_CONTAIN_EMAIL_FAILED(HttpStatus.BAD_REQUEST, false, 2111, "이메일이 포함된 비밀번호 입니다."),
